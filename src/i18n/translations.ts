...
export const translations: Record<Locale, Translation> = {
  id: {
    ...
    hero: {
      ...
      subtitle:
        "Teman-teman biasa memanggil saya Masher — Saya seorang Software Engineer yang senang mengintegrasikan arsitektur, UX, dan user trust.",
      ...
      badge:
        "Tinggal di Jawa Barat, Indonesia · Mengutamakan kolaborasi remote—onsite bila diperlukan",
    },
    experience: {
    ...
    stack: {
      title: "Stack favorit",
      intro:
        "Teknologi dan pola kerja yang saya pakai untuk menjaga kualitas, keamanan, dan keberlanjutan produk.",
      categories: [
        {
    ...
    deliverables: {
      ...
      intro:
        "Solusi yang saya bangun untuk membuat teknologi terasa akrab, trustworthy, dan bermakna bagi masyarakat.",
      items: [
        {
          title: "Progressife Web App",
          description:
            "Aplikasi web responsif dan offline-friendly yang terasa natural di berbagai perangkat.",
          icon: "ri-smartphone-line",
        },
        {
          title: "Assistant & Knowledge Hub",
          description:
            "Chatbot, knowledge base, dan playbook digital yang membantu komunitas serta organisasi sosial mengambil keputusan.",
          icon: "ri-chat-smile-2-line",
        },
        {
          title: "Automasi & Guardrail",
          description:
            "Script, pipeline, dan tooling untuk testing, security checks, serta orkestrasi kerja berulang.",
          icon: "ri-cpu-line",
        },
        {
          title: "Enablement Digital",
          description:
            "Workshop, dashboard, dan workflows yang membantu relawan dan organisasi sosial lebih percaya diri memakai data & otomasi.",
          icon: "ri-team-line",
        },
      ],
    },
      ...
      tools: [
        {
          ...
          stack: ["Angular 20", "Tailwind CSS", "Cloudflare Pages"],
        },
        {
          ...
          status: "available",
          link: "/webtools/kalender-nasional",
          stack: ["React 19", "Vite", "Tailwind CSS", "Cloudflare Pages"],
        },
        {
  ...
  en: {
    ...
    hero: {
      status:
        "Currently crafting digital experiences with a human & data heartbeat",
      name: "Hi, I'm Heriyanto",
      subtitle:
        "Friends usually call me MasHer—a software craftsman who enjoys aligning architecture, UX, and data trust.",
      ...
      badge:
        "Based in Indonesia · Remote-first collaborator, onsite when it truly helps",
    },
    experience: {
      title: "Reliable software",
    ...
    stack: {
      ...
      intro:
        "Technologies and practices I fall back on to craft secure, maintainable, people-friendly products.",
      categories: [
        {
          title: "Frontend playground",
          items: ["React", "Angular", "Tailwind CSS", "Hono", "RxDB"],
    ...
    deliverables: {
      ...
      intro:
        "Solutions I build to make technology approachable, safe, and genuinely useful for social-good work.",
      items: [
        {
          title: "Progressive Web Experiences",
          description:
            "Responsive, offline-ready interfaces that feel natural across devices and contexts.",
          icon: "ri-smartphone-line",
        },
        {
          title: "Assistants & Knowledge Hubs",
          description:
            "Conversational tools, knowledge bases, and playbooks that empower civic groups and mission-driven teams.",
          icon: "ri-chat-smile-2-line",
        },
        {
          title: "Automation & Guardrails",
          description:
            "Reusable pipelines for testing, provisioning, security reviews, and operational guardrails.",
          icon: "ri-cpu-line",
        },
        {
          title: "Digital Enablement",
          description:
            "Workshops, dashboards, and workflows that help social initiatives embrace data and automation responsibly.",
          icon: "ri-team-line",
        },
      ],
    },
    contact: {
      ...
      intro:
        "Curious about software craftsmanship, data safeguards, or amplifying social impact with technology? Ping me through whichever channel feels right.",
      channels: {
        email: "Email",
        github: "GitHub",
        linkedin: "LinkedIn",
      ...
      glossary: [
        {
          ...
          description:
            "Core vocabulary that explains how access, safeguards, and policy-driven controls keep information trustworthy.",
          items: [
            {
              term: "Adequate Security",
              summary:
                "Safeguards scaled to the level of risk and potential harm if information is lost, misused, accessed, or modified without authorization.",
              notes: "Source: OMB Circular A-130.",
            },
            {
              term: "Administrative Controls",
              summary:
                "Policy- and procedure-based controls, such as access provisioning workflows or dual-control requirements, typically enforced alongside technical and physical safeguards.",
            },
            {
              term: "Asset",
              summary:
                "Anything of value owned by the organization, covering tangible systems and property as well as intangible intellectual property.",
            },
            {
              term: "Authentication",
              summary:
                "The act of verifying the identity or eligibility of a station, originator, or individual before granting access to specific information categories.",
            },
            {
              term: "Authorization",
              summary:
                "The right or permission granted to a system entity to access a particular resource, usually linked to roles and duties.",
              notes: "Source: NIST SP 800-82 Rev.2.",
            },
            {
              term: "Availability",
              summary:
                "Ensuring authorized users have reliable, timely access to information when they need it.",
            },
            {
              term: "Baseline",
              summary:
                "The documented minimum-security configuration permitted by organizational standards or policy.",
            },
            {
              term: "Biometric",
              summary:
                "Biological traits—such as fingerprints, hand geometry, voice, or iris patterns—used to authenticate individuals.",
            },
            {
              term: "CIA Triad",
              summary:
                "A framework emphasizing confidentiality, integrity, and availability as the three pillars of information security.",
            },
            {
              term: "Confidentiality",
              summary:
                "The state in which data is not disclosed or made available to unauthorized people or processes.",
              notes: "Source: NIST SP 800-66.",
            },
            {
              term: "Zero Trust",
              summary:
                "A security posture that validates every request instead of trusting internal networks by default, frequently reinforced with microsegmentation and identity-centric controls.",
            },
            {
              term: "Least Privilege",
              summary:
                "The practice of granting only the minimum access a role needs to perform its responsibilities—also referred to as the principle of least privilege.",
              notes: "Source: NIST SP 800-179.",
            },
            {
              term: "Mandatory Access Control (MAC)",
              summary:
                "An access model where the system enforces permissions strictly according to organizational security policies.",
            },
            {
              term: "Mantrap",
              summary:
                "An entrance that requires passing through two interlocking doors, allowing only one door to open at a time to verify entrants.",
            },
            {
              term: "Microsegmentation",
              summary:
                "A zero trust technique that breaks networks into tightly scoped zones using firewalls or similar controls at each connection point.",
            },
            {
              term: "Multi-Factor Authentication (MFA)",
              summary:
                "Identity verification that uses two or more distinct factors—something you know, have, or are.",
            },
            {
              term: "Single-Factor Authentication",
              summary:
                "Authentication that relies on only one factor, such as a password, and therefore provides lower assurance.",
            },
            {
              term: "National Institute of Standards and Technology (NIST)",
              summary:
                "A U.S. Department of Commerce agency that advances measurement science and develops standards, including cybersecurity frameworks.",
            },
            {
              term: "Non-repudiation",
              summary:
                "The assurance that an individual cannot deny creating, approving, sending, or receiving specific information.",
            },
            {
              term: "Classification",
              summary:
                "The process of identifying the potential harm that could occur if an information asset is exposed, so the correct protection level can be assigned.",
            },
            {
              term: "Classified or Sensitive Information",
              summary:
                "Information designated for protection against unauthorized disclosure and marked to indicate its classification level when documented.",
            },
            {
              term: "Configuration Management",
              summary:
                "A discipline that ensures only authorized and validated changes are introduced into a system.",
            },
            {
              term: "Defense in Depth",
              summary:
                "A security strategy that integrates people, technology, and operations to build layered defenses across the organization.",
              notes: "Source: NIST SP 800-53 Rev.4.",
            },
            {
              term: "Discretionary Access Control (DAC)",
              summary:
                "An access model that lets the object owner—or another authorized controller—decide who receives access rights and what those rights entail.",
              notes: "Source: NIST SP 800-192.",
            },
            {
              term: "Object",
              summary:
                "A passive system-related entity—such as devices, files, tables, or processes—that contains or receives information.",
              notes: "Source: NIST SP 800-53 Rev.4.",
            },
            {
              term: "Subject",
              summary:
                "An individual, process, or device that causes information to flow among objects or alters system state.",
              notes: "Source: NIST SP 800-53 Rev.4.",
            },
            {
              term: "Governance",
              summary:
                "The process for steering an organization, covering how decisions are made as well as the policies, roles, and procedures that support them.",
            },
            {
              term: "General Data Protection Regulation (GDPR)",
              summary:
                "Comprehensive European Union legislation passed in 2016 that frames personal privacy as an individual human right.",
            },
            {
              term: "Layered Defense",
              summary:
                "Arranging multiple controls in series to provide consecutive protection for an asset; often referred to as defense in depth.",
            },
            {
              term: "Logical Access Control Systems",
              summary:
                "Automated systems that validate identity (via PINs, cards, biometrics, or tokens) and tailor access privileges to roles and responsibilities.",
              notes: "Source: NIST SP 800-53 Rev.5.",
            },
            {
              term: "Physical Controls",
              summary:
                "Security safeguards implemented through tangible mechanisms such as walls, fences, guards, locks, and badge readers.",
            },
            {
              term: "Privileged Account",
              summary:
                "An information system account with elevated authorizations granted to a privileged user.",
              notes: "Source: NIST SP 800-53 Rev.4.",
            },
            {
              term: "Role-Based Access Control (RBAC)",
              summary:
                "An access control system that assigns user permissions based on organizational roles.",
            },
            {
              term: "Rule",
              summary:
                "An instruction that allows or denies system access by comparing a validated identity with an access control list.",
            },
            {
              term: "Security Controls",
              summary:
                "The management, operational, and technical safeguards prescribed to protect the confidentiality, integrity, and availability of systems and information.",
              notes: "Source: FIPS PUB 199.",
            },
            {
              term: "Technical Controls",
              summary:
                "Security controls primarily implemented and executed by hardware, software, or firmware mechanisms.",
            },
            {
              term: "Security Governance",
              summary:
                "The totality of policies, roles, and processes that guide security decisions within an organization.",
            },
            {
              term: "Security Operations Center (SOC)",
              summary:
                "A centralized function that monitors, detects, and analyzes security events to prevent business disruption.",
            },
            {
              term: "Segregation of Duties",
              summary:
                "The practice of splitting processes so that no single person can complete them end-to-end, reducing insider risk.",
            },
            {
              term: "Token",
              summary:
                "A physical object a user controls and presents to help authenticate their identity.",
              notes: "Source: NISTIR 7711.",
            },
            {
              term: "Turnstile",
              summary:
                "A one-way rotating barrier that allows only one person at a time into a protected area.",
            },
            {
              term: "User Provisioning",
              summary:
        ...
        },
        {
          ...
          description:
            "Terminology for reading threats, maintaining compliance, and sustaining operations during disruption.",
          items: [
            {
              term: "Adverse Events",
              summary:
                "Events with negative consequences, such as system crashes, packet floods, unauthorized privilege use, website defacement, or malicious code that destroys data.",
            },
            {
              term: "Audit",
              summary:
                "An independent review of records and activities to assess whether system controls are adequate and policies are being followed.",
              notes: "Source: NIST SP 1800-15B.",
            },
            {
              term: "Breach",
              summary:
                "Loss of control, compromise, or unauthorized disclosure of personally identifiable information, including access by authorized users for unauthorized purposes.",
              notes: "Source: NIST SP 800-53 Rev.5.",
            },
            {
              term: "Business Continuity (BC)",
              summary:
                "Actions, processes, and tools that help an organization keep critical operations running during contingencies.",
            },
            {
              term: "Business Continuity Plan (BCP)",
              summary:
                "Documented instructions or procedures for sustaining mission and business processes during and after a significant disruption.",
            },
            {
              term: "Business Impact Analysis (BIA)",
              summary:
                "An analysis of system requirements, functions, and interdependencies used to prioritize contingency needs during significant disruption.",
              notes: "Source: NIST SP 800-34 Rev.1.",
            },
            {
              term: "Impact",
              summary:
                "The magnitude of harm that could result if a threat successfully exploits a vulnerability.",
            },
            {
              term: "Information Security Risk",
              summary:
                "The potential adverse effects on operations, assets, people, other organizations, or the nation arising from unauthorized access, use, disclosure, disruption, modification, or destruction of information or systems.",
            },
            {
              term: "Probability",
              summary:
                "The likelihood that a threat actor is capable of exploiting a particular vulnerability.",
              notes: "Source: NIST SP 800-30 Rev.1.",
            },
            {
              term: "Qualitative Risk Analysis",
              summary:
                "A risk analysis method that assigns descriptors—such as low, medium, or high—to impact and likelihood.",
              notes: "Source: NISTIR 8286.",
            },
            {
              term: "Quantitative Risk Analysis",
              summary:
                "A risk analysis method that uses numeric impact and likelihood values based on statistical probability and monetary loss estimates.",
              notes: "Source: NISTIR 8286.",
            },
            {
              term: "Data Loss Prevention (DLP)",
              summary:
                "System capabilities designed to detect and prevent the unauthorized use or transmission of information.",
            },
            {
              term: "Denial-of-Service (DoS)",
              summary:
                "The prevention of authorized access to resources or the delay of time-critical operations needed to deliver a service.",
              notes: "Source: NIST SP 800-27 Rev. A.",
            },
            {
              term: "Disaster Recovery (DR)",
              summary:
                "Activities needed to restore IT and communications services during and after an outage or disruption.",
            },
            {
              term: "Disaster Recovery Plan (DRP)",
              summary:
                "Policies, processes, and procedures for resuming critical business functions, technology infrastructure, systems, and applications after a disaster.",
            },
            {
              term: "Event",
            ...
            },
            {
              term: "Exploit",
              summary:
                "A specific attack that takes advantage of a system vulnerability.",
            },
            {
              term: "Incident",
              summary:
                "An event that actually or potentially jeopardizes the confidentiality, integrity, or availability of a system or the information it handles.",
            },
            {
              term: "Incident Handling / Incident Response (IR)",
              summary:
                "The process of detecting and analyzing incidents so the impact stays contained.",
            },
            {
              term: "Incident Response Plan (IRP)",
              summary:
                "Predocumented procedures to detect, respond to, and limit the consequences of malicious cyber attacks.",
              notes: "Source: NIST SP 800-34 Rev.1.",
            },
            {
              term: "Insider Threat",
              summary:
                "An authorized entity that could harm the system by destroying, disclosing, modifying data, or causing denial of service.",
              notes: "Source: NIST SP 800-32.",
            },
            {
              term: "Intrusion",
              summary:
                "A sequence of security events that constitute an incident where an intruder attempts to gain unauthorized access.",
              notes: "Source: IETF RFC 4949 Ver.2.",
            },
            {
              term: "Likelihood",
              summary:
                "The probability that a particular vulnerability will be exercised in the prevailing threat environment.",
            },
            {
              term: "Likelihood of Occurrence",
              summary:
                "A weighted factor reflecting the assessed chance that a threat can exploit a given vulnerability.",
            },
            {
              term: "Log Anomaly",
              summary:
                "An irregularity spotted during log analysis that may indicate events worth further investigation.",
            },
            {
              term: "Logging",
              summary:
                "Collecting and storing user activities as event records across systems and networks.",
              notes: "Source: NIST SP 1800-25B.",
            },
            {
              term: "Records",
              summary:
                "Documented evidence of activities or results that verify systems and organizations perform as intended.",
              notes: "Source: NIST SP 800-53 Rev.4.",
            },
            {
              term: "Records Retention",
              summary:
                "The practice of retaining records for as long as necessary and then disposing of them after the appropriate interval.",
            },
            {
              term: "Remanence",
              summary:
            ...
            },
            {
              term: "Request for Change (RFC)",
              summary:
                "The initial change-management step where a stakeholder proposes a modification to a procedure or product.",
            },
            {
              term: "Risk",
              summary:
            ...
            },
            {
              term: "Risk Acceptance",
              summary:
                "Deciding to tolerate a risk because the potential benefits outweigh the impact.",
            },
            {
              term: "Risk Assessment",
              summary:
                "Identifying and analyzing risks to operations, assets, individuals, and other organizations.",
            },
            {
              term: "Risk Avoidance",
              summary:
                "Choosing not to perform a business activity because the associated risk is too high.",
            },
            {
              term: "Risk Management",
              summary:
                "Identifying, evaluating, and controlling threats across the risk context, assessment, treatment, and monitoring phases.",
            },
            {
              term: "Risk Management Framework",
              summary:
                "A structured approach for overseeing and managing enterprise risk.",
              notes: "Source: CNSSI 4009.",
            },
            {
              term: "Risk Mitigation",
              summary:
                "Implementing security controls to reduce the impact or likelihood of a specific risk.",
            },
            {
              term: "Risk Tolerance",
              summary:
                "The level of risk an entity is willing to assume—also called risk appetite or acceptable risk.",
            },
            {
              term: "Risk Transference",
              summary:
                "Paying an external party, such as an insurer, to absorb the financial impact of a risk.",
            },
            {
              term: "Risk Treatment",
              summary:
                "Determining the best course of action for a recognized risk.",
            },
            {
              term: "Sensitivity",
              summary:
                "The importance assigned to information by its owner for the purpose of denoting protection needs.",
              notes: "Source: NIST SP 800-60 Vol.1 Rev.1.",
            },
            {
              term: "Threat Modeling",
              summary:
                "A structured process to map assets, possible threats, and mitigation controls early in the design phase.",
            },
            {
              term: "Attack Surface",
              summary:
                "The collection of entry points an attacker could exploit—from APIs and network configs to everyday user behaviour.",
            },
            {
              term: "Vulnerability",
              summary:
                "A weakness in an information system, security procedure, internal control, or implementation that could be exploited by a threat source.",
              notes: "Source: NIST SP 800-128.",
            },
            {
              term: "Incident Response Playbook",
              summary:
                "A step-by-step guide that helps teams detect, respond to, and recover from security incidents.",
            },
            {
              term: "Criticality",
              summary:
                "A measure of how much an organization depends on information or information systems for mission or business success.",
              notes: "Source: NIST SP 800-60 Vol.1 Rev.1.",
            },
            {
              term: "Crime Prevention through Environmental Design (CPTED)",
              summary:
                "An architectural approach that uses passive design features to reduce opportunities for criminal activity.",
            },
          ],
        },
        {
          ...
          description:
            "Terms that describe how adversaries exploit systems and the tactics defenders must recognize.",
          items: [
            {
              term: "Man-in-the-Middle (MitM)",
              summary:
                "An attack in which the adversary positions themselves between user and system to intercept or alter data in transit.",
              notes: "Source: NISTIR 7711.",
            },
            {
              term: "Oversized Packet Attack",
              summary:
                "Deliberately sending packets larger than expected so the receiving system fails to process them.",
            },
            {
              term: "Payload",
              summary:
                "The primary malicious action delivered by a piece of code after it executes.",
            },
            {
              term: "Ransomware",
              summary:
                "Malicious software that locks screens or encrypts files until a payment is made.",
            },
            {
              term: "Social Engineering",
              summary:
                "Techniques that manipulate people—via email, phone, text, or in-person ploys—to gain system access.",
            },
            {
              term: "Spoofing",
              summary:
                "Faking a sender’s identity or address to gain unauthorized system access.",
              notes: "Source: CNSSI 4009-2015.",
            },
            {
              term: "Threat",
              summary:
                "Any circumstance or event with the potential to adversely affect operations, assets, individuals, other organizations, or the nation.",
              notes: "Source: NIST SP 800-30 Rev.1.",
            },
            {
              term: "Threat Actor",
              summary:
                "An individual or group attempting to exploit vulnerabilities to realize a threat.",
            },
            {
              term: "Threat Vector",
              summary:
                "The path or method a threat actor uses to achieve their objectives.",
            },
            {
              term: "Whaling Attack",
              summary:
                "A phishing campaign that targets high-level executives or wealthy individuals to authorize large fund transfers.",
            },
            {
              term: "Zero Day",
              summary:
                "A previously unknown vulnerability that attackers can exploit before detection signatures or patches exist.",
            },
          ],
        },
        {
          ...
          description:
            "Technology building blocks that power digital services, collaboration, and automation.",
          items: [
            {
              term: "Application Programming Interface (API)",
              summary:
                "A set of routines, standards, protocols, and tools for building software applications that interact with web-based services or tools.",
            },
            {
              term: "Application Server",
              summary:
                "A computer responsible for hosting applications so they can be accessed by user workstations.",
              notes: "Source: NIST SP 800-82 Rev.2.",
            },
            {
              term: "Artificial Intelligence",
              summary:
                "The ability of computers or robots to simulate human intelligence and behaviour.",
            },
            {
              term: "Broadcast",
              summary:
                "A one-to-many transmission method that sends internet traffic from a single source to every receiver on a segment.",
            },
            {
              term: "Bot",
              summary:
                "Malicious code that lets an attacker remotely control compromised systems, often with trojan or worm capabilities.",
            },
            {
              term: "Cloud Computing",
              summary:
                "A model for on-demand network access to a shared pool of configurable computing resources that can be rapidly provisioned with minimal management effort.",
              notes: "Source: NIST SP 800-145.",
            },
            {
              term: "Community Cloud",
              summary:
                "Cloud infrastructure provisioned for exclusive use by a community of organizations with shared concerns, which may be owned or operated by one or more members, a third party, or a combination of them, on- or off-premises.",
              notes: "Source: NIST SP 800-145.",
            },
            {
              term: "De-encapsulation",
              summary:
                "The reverse of encapsulation, in which bundled data is unpacked or revealed from its wrapper.",
            },
            {
              term: "Domain Name Service (DNS)",
              summary:
                "A term that can refer to the service, the physical servers, and the protocol that map domain names to IP addresses and back again.",
            },
            {
              term: "Egress Monitoring",
              summary:
                "Monitoring outbound network traffic to spot suspicious patterns or data exfiltration attempts.",
            },
            {
              term: "Encapsulation",
              summary:
                "Bundling data and methods so they are hidden during development and runtime; also refers to wrapping data inside other structures, as in networking and encryption.",
            },
            {
              term: "File Transfer Protocol (FTP)",
              summary:
                "The internet protocol—and associated programs—used to transfer files between hosts.",
            },
            {
              term: "Firewalls",
              summary:
                "Devices that enforce administrative security policies by filtering inbound traffic according to defined rules.",
            },
            {
              term: "Fragment Attack",
              summary:
                "An attack that fragments packets so a system cannot reassemble the data correctly.",
            },
            {
              term: "Infrastructure as a Service (IaaS)",
              summary:
                "A service model that delivers core compute, storage, and networking resources so teams can build and deploy applications—typically billed on consumption.",
            },
            {
              term: "Ingress Monitoring",
              summary:
                "Monitoring inbound network traffic to surface potential threats early.",
            },
            {
              term: "Institute of Electrical and Electronics Engineers (IEEE)",
              summary:
                "A professional organization that defines standards spanning telecommunications, computer engineering, and related fields.",
            },
            {
              term: "International Organization for Standardization (ISO)",
              summary:
                "A body that develops voluntary international standards, collaborating with IEC and ITU across information and communication technologies.",
            },
            {
              term: "Internet Control Message Protocol (ICMP)",
              summary:
                "An IP network protocol standardized via IETF RFC 792 to check host or service availability.",
            },
            {
              term: "Internet Engineering Task Force (IETF)",
              summary:
                "The standards body of internet designers, operators, vendors, and researchers who shape protocols through collaboration and consensus.",
              notes: "Source: NIST SP 1800-16B.",
            },
            {
              term: "Internet Protocol (IPv4)",
              summary:
                "The standard protocol for transporting data between endpoints over interconnected packet-switched networks.",
              notes: "Source: CNSSI 4009-2015.",
            },
            {
              term: "iOS",
            ...
            },
            {
              term: "Linux",
              summary:
                "An open-source operating system whose source code is legally accessible to end users.",
            },
            {
              term: "Packet",
              summary:
                "A Layer 3 representation of data carried across a network in the OSI model.",
            },
            {
              term: "Platform as a Service (PaaS)",
              summary:
                "A cloud development environment that lets teams build applications before deploying them as SaaS solutions.",
            },
            {
              term: "Private Cloud",
              summary:
                "A cloud environment operated within an organization’s boundary so it can retain control over data and compliance.",
            },
            {
              term: "Public Cloud",
              summary:
                "Cloud infrastructure provisioned for public use and operated by commercial, academic, or government providers.",
              notes: "Source: NIST SP 800-145.",
            },
            {
              term: "Protocols",
              summary:
                "Sets of format and procedure rules that govern communication between systems.",
              notes: "Source: NIST SP 800-82 Rev.2.",
            },
            {
              term: "Simple Mail Transport Protocol (SMTP)",
              summary:
                "The standard communication protocol for sending and receiving email between senders and receivers.",
            },
            {
              term: "Software as a Service (SaaS)",
              summary:
                "A cloud model where consumers use provider-run applications without managing the underlying infrastructure.",
              notes: "Source: NIST SP 800-145.",
            },
            {
              term: "Transport Control Protocol/Internet Protocol (TCP/IP) Model",
              summary:
                "The IETF model defining link, internet, transport, and application layers for internetworked communication.",
            },
            {
              term: "Virtual Local Area Network (VLAN)",
              summary:
                "A logical grouping of devices and servers that appear to share a LAN despite geographic distribution.",
            },
            {
              term: "Virtual Private Network (VPN)",
              summary:
                "A secure communication tunnel built on top of existing networks to connect sites privately.",
            },
            {
              term: "Web Server",
              summary:
                "A computer that delivers web services, including hardware, operating system, server software, and site content.",
              notes: "Source: NIST SP 800-44 Version 2.",
            },
            {
              term: "Wireless Local Area Network (WLAN)",
              summary:
                "A local area network based on radio transmissions—Wi-Fi being a common example.",
            },
            {
              term: "Zenmap",
              summary:
                "The graphical interface for Nmap used to scan networks and identify connected systems and services.",
            },
          ],
        },
        {
          ...
          description:
            "Concepts that protect data integrity, confidentiality, and authenticity.",
          items: [
            {
              term: "Asymmetric Encryption",
              summary:
                "An algorithm that uses one key to encrypt plaintext and a different key to decrypt it.",
            },
            {
              term: "Bit",
              summary:
                "The most basic representation of data—a zero or one—at the physical layer of the OSI model.",
            },
            {
              term: "Byte",
              summary:
            ...
            },
            {
              term: "Checksum",
              summary:
                "A calculated value representing the sum of data elements, later used to detect errors when the data is stored or transmitted.",
            },
            {
              term: "Ciphertext",
              summary:
                "The transformed form of plaintext that is unreadable to anyone except the intended recipients who have the right key.",
            },
            {
              term: "Cryptanalyst",
              summary:
                "A specialist who performs cryptanalysis—studying methods to break cryptographic techniques or uncover weaknesses in their implementation.",
            },
            {
              term: "Cryptography",
              summary:
                "The study and application of methods for securing the meaning and content of information through disguise, obfuscation, or other transformations.",
            },
            {
              term: "Data Integrity",
              summary:
                "The property that data has not been altered in an unauthorized manner—whether at rest, in processing, or in transit.",
              notes: "Source: NIST SP 800-27 Rev. A.",
            },
            {
              term: "Degaussing",
              summary:
                "A data-erasure technique for magnetic media that removes residual magnetism so information cannot be reconstructed.",
            },
            {
              term: "Decryption",
              summary:
                "The reverse of encryption: converting ciphertext back to plaintext using the appropriate algorithm and key.",
            },
            {
              term: "Digital Signature",
              summary:
                "A cryptographic transformation that, when implemented correctly, provides origin authentication, data integrity, and signer non-repudiation.",
              notes: "Source: NIST SP 800-12 Rev.1.",
            },
            {
              term: "Integrity",
              summary:
                "The property that information remains complete, accurate, internally consistent, and fit for its intended purpose.",
            },
            {
              term: "Encrypt",
              summary:
                "To protect information by converting it to a form that only authorized parties can read.",
            },
            {
              term: "Encryption",
              summary:
                "The act of converting plaintext into ciphertext—also referred to as enciphering.",
            },
            {
              term: "Encryption System",
              summary:
                "The complete set of algorithms, processes, hardware, software, and procedures that provide encryption and decryption capabilities.",
            },
            {
              term: "Message Digest",
              summary:
                "A digital fingerprint that uniquely identifies data and changes completely if even a single bit is altered.",
              notes: "Source: NISTIR 8011 Vol.3.",
            },
            {
              term: "Payment Card Industry Data Security Standard (PCI DSS)",
              summary:
                "An information security standard for merchants and service providers processing payment cards.",
            },
            {
              term: "Personally Identifiable Information (PII)",
              summary:
                "Any information that can distinguish or trace an individual’s identity, or is linked or linkable to them.",
              notes: "Source: NIST SP 800-122.",
            },
            {
              term: "Plaintext",
              summary:
                "Data in its natural, readable form—highly vulnerable from a confidentiality standpoint.",
            },
            {
              term: "Privacy",
              summary:
                "An individual’s right to control how information about them is distributed.",
            },
            {
              term: "Protected Health Information (PHI)",
              summary:
                "Health status, care, or payment information as defined under HIPAA.",
            },
            {
              term: "Symmetric Encryption",
              summary:
                "An algorithm that uses the same key to both encrypt and decrypt data.",
            },
            {
              term: "System Integrity",
              summary:
                "The quality of a system that performs its intended function without unauthorized manipulation—intentional or accidental.",
              notes: "Source: NIST SP 800-27 Rev. A.",
            },
          ],
        },
        {
          ...
          description:
            "Engineering practices that balance product quality with a strong security posture.",
          items: [
            {
              term: "Secure SDLC",
              summary:
                "A development approach that embeds security checks in every phase—from discovery through maintenance.",
            },
            {
              term: "Observability",
              summary:
                "The ability to understand system health through logs, metrics, and traces so anomalies surface quickly.",
            },
            {
              term: "Chaos Engineering",
              summary:
                "Controlled experiments that stress systems with real-world failures to improve resilience.",
            },
            {
              term: "Operating System",
              summary:
                "The “master control” software whose kernel stays in memory, setting standards for applications and handling user interaction and file management.",
              notes: "Source: NIST SP 800-44 Version 2.",
            },
            {
              term: "Patch",
              summary:
                "A software component that modifies related files or settings to fix issues without changing version or release identifiers.",
              notes: "Source: ISO/IEC 19770-2.",
            },
            {
              term: "Patch Management",
              summary:
                "The systematic notification, identification, deployment, installation, and verification of operating system and application code revisions.",
              notes: "Source: CNSSI 4009.",
            },
            {
              term: "Software",
              summary:
                "Computer programs and associated data that can be dynamically written or modified during execution.",
              notes: "Source: NIST SP 800-37 Rev.2.",
            },
            {
              term: "State",
              summary:
                "The condition an entity is in at a specific point in time.",
            },
            {
              term: "Unix",
              summary:
                "An operating system commonly used in software development and network services.",
            },
          ],
        },
      ],
    ...
    learningJourney: {
      meta: {
        ...
        description:
          "A personal journal capturing my study notes and experiments while exploring new disciplines.",
      },
      title: "Journal",
      intro:
